...
namespace ShapesAndColorsChallenge.Class.Effects.Bloom
{
    ...
    public class BloomFilter : IDisposable
    {
        ...
        /// <summary>
        /// Indica si la textura estará a mitad de su resolución para ahorrar recursos.
        /// </summary>
        ...
        public void Load(GraphicsDevice graphicsDevice, ContentManager content, int width, int height, SurfaceFormat renderTargetFormat = SurfaceFormat.Color, QuadRenderer quadRenderer = null)
        {
            ...
            _bloomEffect = content.Load<Effect>(@"Shader\Bloom");
        ...
        internal void SetValues(BloomValues bloomValues)
        {
            ...
            BloomStreakLength = bloomValues.BloomStreakLength;
            BloomStrengthMultiplier = bloomValues.BloomStrengthMultiplier;
        }
        ...
        public void UpdateResolution(int width, int height)
        {
            ...
            _bloomRenderTarget2DMip0 = new RenderTarget2D(_graphicsDevice, width, height, false, _renderTargetFormat, DepthFormat.None, 0, RenderTargetUsage.DiscardContents);
            _bloomRenderTarget2DMip1 = new RenderTarget2D(_graphicsDevice, width / 2, height / 2, false, _renderTargetFormat, DepthFormat.None, 0, RenderTargetUsage.PreserveContents);
            _bloomRenderTarget2DMip2 = new RenderTarget2D(_graphicsDevice, width / 4, height / 4, false, _renderTargetFormat, DepthFormat.None, 0, RenderTargetUsage.PreserveContents);
            _bloomRenderTarget2DMip3 = new RenderTarget2D(_graphicsDevice, width / 8, height / 8, false, _renderTargetFormat, DepthFormat.None, 0, RenderTargetUsage.PreserveContents);
            _bloomRenderTarget2DMip4 = new RenderTarget2D(_graphicsDevice, width / 16, height / 16, false, _renderTargetFormat, DepthFormat.None, 0, RenderTargetUsage.PreserveContents);
            _bloomRenderTarget2DMip5 = new RenderTarget2D(_graphicsDevice, width / 32, height / 32, false, _renderTargetFormat, DepthFormat.None, 0, RenderTargetUsage.PreserveContents);
        }
